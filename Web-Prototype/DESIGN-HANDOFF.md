# 2a8c3f75-e98d-4107-bb44-15a96e5b3418 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `chirpset-brand-toolkit-symmetric.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `chirpset-brand-toolkit-symmetric.html`
...
- A single self-contained `chirpset-brand-toolkit-symmetric.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `chirpset-brand-toolkit-symmetric.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `chirpset-brand-toolkit-symmetric.html`
- `chirpset-brand-toolkit.html`
- `chirpset-prototype-bird.html`
- `chirpset-prototype.html`
...
1. Inspect `chirpset-brand-toolkit-symmetric.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
